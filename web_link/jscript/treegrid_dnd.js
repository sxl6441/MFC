...
//Treegrid drag and drop operation.
...
//                    //==================================
//                    //做自己的逻辑处理
//                    var src  = $('#templates_list').treegrid('find', $(source).attr('node-id'));
//                    var dest = $('#templates_list').treegrid('find', $(this).attr('node-id'));
//                    alert("Source : " + src.plannode+", targe : "+dest.plannode);
////                    $.ajax({
